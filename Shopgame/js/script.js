window.onload = function(){
   ...
   class UI{ 
       constructor(){
           ...
           this.help.addEventListener("click",this.helped);
           this.covers = {
            title: "",
            descr: "",
            cover: ""
        ...
        searchGame = () =>{
            window.history.pushState({id: 1},null,"?q=1234&i=beware");
        ...
        helped = () =>{
            ...
            <div class="intro">
            <h6>some problem and you do not know what to do contact our support service Coders Developers</h6>
            <img src="./img/gmail.png">
            <li><a href="https://mail.google.com/mail/u/0/?hl=es#inbox">HAROLDC2005@GMAIL.COM</a></li>
            </div
            </div>
            `);
            $("#title").css("text-align","center");
            $(".zongame").css("width","35%");
            $(".zongame").css("margin-left","35vh");
            $(".zongame").css("height","0px");
            $(".intro").css("margin","20px 15px");
            $(".intro > img").css("border-radius","10%");
            $(".intro > img").css("width","350px");
            $(".intro > img").css("margin","16px 60px");
            $(".intro > img").css("height","350px");
            $(".intro > li").css("text-align","center");
            $(".intro > li").css("margin-top","15px");
            $(".containp").css("background","#000");
            $(".containp").addClass("containpp");
            $(".help > #title > h2").css("color","#777");
            $(".help > .intro > h6").css("color","#777");
            window.history.pushState({id: 1},null,"?q=1234&o=beware");
            window.addEventListener("popstate",function(){
                window.location.href = "file:///C:/Users/Usuario/OneDrive/Documentos/Shopgame/index.html";
            });
        }
